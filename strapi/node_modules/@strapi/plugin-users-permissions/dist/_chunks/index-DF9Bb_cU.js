...
const indexILKTBveZ = require("./index-iLKTBveZ-fMZ4nmrb.js");
...
const index = require("./index-B5V9vp2a.js");
...
const ProvidersPage = () => {
  ...
  const { trackUsage } = indexILKTBveZ.useTracking();
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(indexILKTBveZ.Layouts.Root, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(admin.Page.Main, { children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(indexILKTBveZ.Layouts.Content, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Table, { colCount: 3, rowCount: providers.length + 1, children: [
...
//# sourceMappingURL=index-DF9Bb_cU.js.map
