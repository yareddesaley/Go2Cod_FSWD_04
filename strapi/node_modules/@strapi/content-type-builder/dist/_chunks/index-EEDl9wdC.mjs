...
const ListView$1 = lazy(() => import("./ListView-g5kB4f_y.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-g5kB4f_y.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-EEDl9wdC.mjs.map
