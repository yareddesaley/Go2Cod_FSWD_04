  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => Promise.resolve().then(() => require("./App-DITZWWqI.js")).then((mod) => ({ default: mod.App })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await Promise.resolve().then(() => require("./ReleasesSettingsPage-DZcRvN_O.js"));
...
//# sourceMappingURL=index-TfMp19WL.js.map
