...
import { c as useTracking, r as useConfiguration, p as useAppInfo, k as useRBAC, P as Page } from './Theme-NAd2H4cV.mjs';
...
const ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = useEnterprise(
    AdminSeatInfoCE,
    async () => (await import('./AdminSeatInfo-BtXH5sC-.mjs')).AdminSeatInfoEE
  );
  const {
...
//# sourceMappingURL=ApplicationInfoPage-ChJWPprT.mjs.map
