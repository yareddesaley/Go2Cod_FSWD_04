...
const useWebhooks = require('./useWebhooks-CkRHgTl_.js');
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require('./EventsTable-CTNTkrE7.js'))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-CN0ZI2gY.js.map
