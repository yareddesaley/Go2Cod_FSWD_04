...
import { p as SETTINGS_LINKS_CE, b as Layouts } from './index-iLKTBveZ.mjs';
import { u as useAuth, p as useAppInfo, q as useStrapiApp, c as useTracking, P as Page } from './Theme-NAd2H4cV.mjs';
...
const useSettingsMenu = () => {
  ...
  const { admin: adminLinks, global: globalLinks } = useEnterprise(
    ceLinks,
    async () => (await import('./index-iLKTBveZ.mjs').then(n => n.K)).SETTINGS_LINKS_EE(),
    {
...
export { Layout };
//# sourceMappingURL=Layout-dokm6bl0.mjs.map
