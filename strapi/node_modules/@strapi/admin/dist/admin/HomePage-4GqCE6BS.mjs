...
import { b as Layouts, v as ContentBox } from './index-iLKTBveZ.mjs';
import { m as useGuidedTour, c as useTracking, e as useAPIErrorHandler, a as useNotification, P as Page, p as useAppInfo } from './Theme-NAd2H4cV.mjs';
...
const HomePage = () => {
  const Page2 = useEnterprise(
    ...
    async () => (await import('./HomePage-DjkDfQrs.mjs')).HomePageEE
  );
  if (!Page2) {
    return null;
  }
...
//# sourceMappingURL=HomePage-4GqCE6BS.mjs.map
